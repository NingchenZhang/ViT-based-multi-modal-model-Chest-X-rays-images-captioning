...
def train_process(model, device, train_loader, optimizer, epoch, text_processor):
    ...
    correct = 0
    total = 0
    pbar = tqdm(train_loader, desc=f"Training epoch {epoch}")  # 添加进度条
...
if __name__ == "__main__":
    ...
    checkpoint_path = trained_path  # Change to your weight file path  !!!!if you want to train from existing weight
